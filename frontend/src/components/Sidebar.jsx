...
export default function Sidebar({ isOpen, currentRole, onClose }) {
  ...
  const roleColor = {
    ...
    certifier: 'bg-blue-100 text-blue-800',
      ...
      <div className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col">
        <div className="flex flex-col flex-grow bg-white border-r border-gray-200">
          ...
          <div className="flex items-center flex-shrink-0 px-6 py-4 border-b border-gray-200">
            ...
            <div className="ml-3">
              <h1 className="text-lg font-semibold text-gray-900">GreenChain</h1>
              <p className="text-sm text-gray-500">H2 Credits</p>
            </div>
          </div>

          {/* Role indicator */}
          <div className="px-6 py-4 border-b border-gray-200">
            <div className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${roleColor[currentRole]}`}>
